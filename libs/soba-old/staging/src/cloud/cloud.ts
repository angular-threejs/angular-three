...
import { extend, injectNgtRef, signalStore, type NgtBeforeRenderEvent, type NgtGroup } from 'angular-three-old';
import { NgtsBillboard } from 'angular-three-soba-old/abstractions';
