...
import { NgtArgs, extend, injectNgtRef, signalStore, type NgtBeforeRenderEvent } from 'angular-three-old';
import { StarFieldMaterial } from 'angular-three-soba-old/shaders';
