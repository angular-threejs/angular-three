...
import { injectBeforeRender, injectNgtRef } from 'angular-three-old';
import { NgtsOrbitControls } from 'angular-three-soba-old/controls';
import { NgtsSegment, NgtsSegments, type SegmentObject } from 'angular-three-soba-old/performances';
