...
import { NgtArgs, signalStore } from 'angular-three-old';
import { injectNgtsTextureLoader } from 'angular-three-soba-old/loaders';
import { NgtsMeshReflectorMaterial } from 'angular-three-soba-old/materials';
import { NgtsEnvironment } from 'angular-three-soba-old/staging';
