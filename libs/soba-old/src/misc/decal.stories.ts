...
import { NgtArgs, injectNgtRef } from 'angular-three-old';
...
import { NgtsDecal, injectNgtsSurfaceSampler, type NgtsSurfaceSamplerTransformFn } from 'angular-three-soba-old/misc';
