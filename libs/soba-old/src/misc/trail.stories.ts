...
import { NgtArgs, injectBeforeRender, injectNgtRef } from 'angular-three-old';
import { NgtsPerspectiveCamera } from 'angular-three-soba-old/cameras';
import { NgtsTrail, injectNgtsTrail, type NgtsTrailState } from 'angular-three-soba-old/misc';
import { NgtsFloat } from 'angular-three-soba-old/staging';
