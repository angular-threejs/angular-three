...
import { checkUpdate, NgtArgs } from 'angular-three-old';
...
import { injectNgtsDepthBuffer } from 'angular-three-soba-old/misc';
import { NgtsEnvironment, NgtsSpotLight, NgtsSpotLightShadow } from 'angular-three-soba-old/staging';
