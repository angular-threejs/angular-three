...
import { extend, injectNgtRef, injectNgtStore, signalStore, type NgtGroup } from 'angular-three-old';
import { NgtsEdges } from 'angular-three-soba-old/abstractions';
import { CausticsMaterial, CausticsProjectionMaterial } from 'angular-three-soba-old/shaders';
