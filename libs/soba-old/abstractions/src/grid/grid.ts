...
import { NgtArgs, extend, injectBeforeRender, injectNgtRef, signalStore, type NgtMesh } from 'angular-three-old';
import { GridMaterial, type NgtGridMaterialState } from 'angular-three-soba-old/shaders';
