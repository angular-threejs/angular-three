...
export function removeInteractivity(store: NgtSignalStore<NgtState>, object: THREE.Object3D): void {
...
export function createEvents(store: NgtSignalStore<NgtState>) {
    ...
    function intersect(event: NgtDomEvent, filter?: (objects: THREE.Object3D[]) => THREE.Object3D[]) {
        ...
        // collect events
        let hits: THREE.Intersection<THREE.Object3D<THREE.Event>>[] = eventObjects
            // intersect objects
