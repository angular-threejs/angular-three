import { getDebugNode, untracked, type Injector, type Type } from '@angular/core';
...
import { SPECIAL_INTERNAL_ADD_COMMENT, SPECIAL_PROPERTIES, attachThreeChild, removeThreeChild } from './utils';
...
export class NgtRendererStore {
    readonly #comments = [] as Array<NgtRendererNode>;
