...
import { injectBeforeRender, injectNgtRef, NgtArgs } from 'angular-three-old';
import distortShader from 'angular-three-soba-old/assets/distort.vert.glsl';
import { NgtsMeshDistortMaterial } from 'angular-three-soba-old/materials';
import { provideNgtsMeshDistortMaterialShader, type MeshDistortMaterial } from 'angular-three-soba-old/shaders';
