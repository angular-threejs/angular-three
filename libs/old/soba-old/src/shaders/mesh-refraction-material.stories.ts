...
import { injectNgtLoader, injectNgtStore, NgtArgs } from 'angular-three-old';
import { NgtsCubeCamera, NgtsCubeCameraContent } from 'angular-three-soba-old/cameras';
...
import { NgtsMeshRefractionMaterial, NgtsMeshTranmissionMaterial } from 'angular-three-soba-old/materials';
import { NgtsCaustics } from 'angular-three-soba-old/misc';
import { NgtsAccumulativeShadows, NgtsEnvironment, NgtsRandomizedLights } from 'angular-three-soba-old/staging';
