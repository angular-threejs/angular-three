		...
		<ngt-mesh>
			...
			<ngt-mesh-standard-material>
				<ngts-render-texture [options]="{ anisotropy: 16 }">
					<ngts-perspective-camera [options]="{ makeDefault: true, aspect: 1 / 1, position: [0, 0, 5] }" />
...
export const Default = makeStoryFunction(DefaultRenderTextureStory, { camera: { position: [5, 5, 5], fov: 25 } });
