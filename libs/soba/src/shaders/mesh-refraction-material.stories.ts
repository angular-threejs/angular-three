...
import { injectNgtLoader, NgtArgs } from 'angular-three';
...
@Component({
    ...
    imports: [NgtsCubeCamera, NgtsCaustics, NgtsCameraContent, NgtsMeshRefractionMaterial, NgIf],
})
class Diamond {
    ...
    readonly #diamondGltf = injectNgtsGLTFLoader(() => 'soba/dflat.glb');
    readonly diamondGeometry = computed(() => {
