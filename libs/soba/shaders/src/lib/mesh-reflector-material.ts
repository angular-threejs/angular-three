...
import { Matrix4, MeshStandardMaterial, Texture, WebGLProgramParametersWithUniforms } from 'three';
...
declare global {
	interface HTMLElementTagNameMap {
		 ...
		 */
		'ngt-mesh-reflector-material': MeshReflectorMaterialOptions & NgtMeshStandardMaterial;
	}
}
